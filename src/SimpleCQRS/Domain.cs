...
namespace SimpleCQRS
{
    public class InventoryItem : AggregateRoot
    {
        ...
        {
            RegisterEventHandler<InventoryItemCreated>(Apply);
            RegisterEventHandler<InventoryItemDeactivated>(Apply);
        }

        public static InventoryItem Create(Guid id, string name)
        {
            var inventoryItem = new InventoryItem();
            inventoryItem.ApplyChange(new InventoryItemCreated(id, name));
    ...
    {
        private readonly Dictionary<Type, Action<object>> _eventHandlerRoutes = new Dictionary<Type, Action<object>>();
        ...
        {
            _eventHandlerRoutes.Add(typeof(TEvent), e => handler((TEvent)e));
        }
